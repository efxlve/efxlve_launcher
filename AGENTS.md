...
- **Kütüphane:** gizleme araması satırı gerçekten gizler (`display:flex` artık `[hidden]` kuralını ezmez). Hover yalnızca kapağı büyütür; kapak altındaki ad yerinde kalır ve kare sistem ipucu açılmaz.
