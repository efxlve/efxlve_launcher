...
- Profil sayfası Xbox PC App ve Steam Profil mimarisi esas alınarak baştan sona yeniden tasarlandı (İki Kolonlu Gamer Profili):
  ...
  - Minimalist Hero Başlığı: Çift katmanlı ve göz yoran kalın kutular, mükerrer XP ve kupa etiketleri kaldırılarak; 56px dairesel avatar, kullanıcı adı, çevrimiçi rozeti, yalın alt satır, PS5 Kupa Seviyesi tek çizgi ilerleme rayı, yatay 4 kademeli kupa dökümü (`3 Platin | 50 Altın | 138 Gümüş | 440 Bronz`) ve tekil yenileme butonundan oluşan sakin ve modern bir konsol başlığına dönüştürüldü.
