...
- Koleksiyonlar (Collections) Steam tarzı zengin kategorize vitrine dönüştürüldü: Segmented rail üzerinden Koleksiyonlar seçildiğinde her koleksiyon özel ikon, başlık, sayaç, düzenleme eylemi ve yatay oyun kartı rafı olarak listelenir; atanmamış oyunlar "Diğer Oyunlar" rafında toplanır; koleksiyon yoksa şık bir boş durum ve "+ Yeni Koleksiyon Oluştur" yönlendirmesi sunulur.
